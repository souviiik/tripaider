                ...
                <div className="container">
                    <div className="columns">
                        <div className="column has-text-centered">
                            ...
                            {!isComingSoon && <ul className="is-size-7 heading footer-links has-text-white">
                                ...
                                <li><Link className="has-text-white site-footer" to="/contact">Login</Link></li>
                                <li><Link className="has-text-white site-footer" to="/contact">Register</Link></li>
                            </ul>
}
                        </div>
                    </div>
